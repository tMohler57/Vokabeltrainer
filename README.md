...
- Es öffnet sich das Startfenser
- Wählen Sie ein Thema, eine Sprache und die gewünschte Übersetzungsrichtung per Drop Down aus
- Sobald Sie eine Auswahl für die drei Variablen getroffen haben, können Sie das Vokabeltraining mittels "Start" beginnen
- Sie werden nun aufgefordert ein gegebenes Wort in die Sprache zu übersetzen, welche Sie zuvor ausgewählt haben
- Geben Sie die Übersetzung in das Eingabefeld ein
- Wenn Sie die Eingabe abgeschlossen haben, drücken Sie auf den Button "Bestätigen"
...
- Wenn Sie das Training beenden wollen, drücken Sie auf "Beenden"
  - Ihnen wird nun angezeigt, wie viele Vokabeln Sie geübt haben und wieviele Sie richtig beantwortet haben. Dies wird Ihnen auch als Prozentsatz angezeigt
  - Sie können das Programm nun mit "Programm beenden" beenden
(Jedes Thema enthält 50 Wörter. Falsch eingegebene Wörter werden wiederholt. Wenn Sie also alle 50 Vokabeln richtig haben, gelangen Sie automatisch zum Endbilschirm.)
